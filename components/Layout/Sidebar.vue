<template>
  ...
  >
    <div class="flex flex-col w-72 h-full px-3">
      ...
      <div class="flex mt-auto text-slate-200">
        <svg class="shrink-0 ml-1 md:ml-1.5 mr-3 md:mr-[26px] fill-slate-200" width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
